...
var HighchartsAdapter = function () {
    ...
    return {
        init: function (a) {
                ...
                Effect.HighchartsTransition = Class.create(Effect.Base, {
                    initialize: function (c, b, d, g) {
                        ...
                        d.attr ? d.element && d.attr(this.options.attribute, c) : (b = {}, b[this
                            .options.attribute] = c, $(d).setStyle(b))
                    }, finish: function () {
                        this.element && this.element._highchart_animation && delete this.element
                            ._highchart_animation[this.key]
                    }
                })
            }
            ...
            var b = $$("head")[0];
            b && b.appendChild((new Element("script", {type: "text/javascript", src: a}))
                                   .observe("load",
                                            c))
        }, addNS: function (a) {
            var c = /^(?:click|mouse(?:down|up|over|move|out))$/;
            return /^(?:load|unload|abort|error|select|change|submit|reset|focus|blur|resize|scroll)$/
                       .test(a) || c.test(a) ? a : "h:" + a
        }, addEvent: function (a, c, b) {
            a.addEventListener || a.attachEvent ? Event.observe($(a), HighchartsAdapter.addNS(c), b)
                : (HighchartsAdapter._extend(a), a._highcharts_observe(c, b))
            ...
            a.fire ? a.fire(HighchartsAdapter.addNS(c), b) : a._highcharts_extended && (b =
                                                                                        b || {}, a
                ._highcharts_fire(c, b));
            b && b.defaultPrevented && (d = null);
            d && d(b)
        }, removeEvent: function (a, c, b) {
            $(a).stopObserving && (c && (c = HighchartsAdapter.addNS(c)), $(a).stopObserving(c, b));
            window === a ? Event.stopObserving(a, c, b) : (HighchartsAdapter._extend(a), a
                ._highcharts_stop_observing(c, b))
            ...
            a._highcharts_extended || Object.extend(a, {
                ...
                _highcharts_stop_observing: function (a, b) {
                    a ? b ? this._highchart_events[a] =
                            [this._highchart_events[a]].compact().flatten().without(b) : delete this
                        ._highchart_events[a] : this._highchart_events = {}
                },
