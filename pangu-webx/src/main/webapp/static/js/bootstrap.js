...
!function ($) {
    ...
    $(document).on('click.carousel.data-api', '[data-slide], [data-slide-to]', function (e) {
        var $this = $(this), href
            , $target = $($this.attr('data-target') || (href = $this.attr('href')) && href
        ...
        , refresh: function () {
            ...
            $targets = this.$body
                ...
                .map(function () {
                         ...
                         return ( $href
                                  && $href.length
                                  && [[$href.position().top + (!$.isWindow(self.$scrollElement
                                                                               .get(0)) && self
...
!function ($) {
    ...
    Typeahead.prototype = {
        ...
        , lookup: function (event) {
            ...
            items =
            $.isFunction(this.source) ? this.source(this.query, $.proxy(this.process, this)) : this
                .source
