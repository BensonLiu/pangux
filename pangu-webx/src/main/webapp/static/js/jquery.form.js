                    ...
                    if (s.extraData) {
                        for (var n in s.extraData) {
                            if (s.extraData.hasOwnProperty(n)) {
                                ...
                                // the same name
                                if ($.isPlainObject(s.extraData[n]) && s.extraData[n]
                                        .hasOwnProperty('name') && s.extraData[n]
                                    ...
                                    extraInputs.push(
                                        $('<input type="hidden" name="' + n + '">').val(s
                                                                                            .extraData[n])
                                            .appendTo(form)[0]);
                                }
                            }
            ...
            for (var i = (one ? index : 0); i < max; i++) {
                ...
                if (op.selected) {
                    ...
                    if (!v) { // extra pain for IE...
                        v =
                        (op.attributes && op.attributes['value'] && !(op.attributes['value']
