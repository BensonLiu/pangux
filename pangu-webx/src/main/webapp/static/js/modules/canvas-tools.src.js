...
(function () {
    ...
    function build() {
        ...
        svg.init = function (ctx) {
            ...
            svg.ViewPort = new (function () {
                ...
                this.ComputeSize = function (d) {
                    ...
                    return Math.sqrt(Math.pow(this.width(), 2) + Math.pow(this.height(), 2)) / Math
                            .sqrt(2);
                }
            });
        }
        ...
        // aspect ratio
        svg.AspectRatio =
        function (ctx, aspectRatio, width, desiredWidth, height, desiredHeight, minX, minY, refX,
                  refY) {
            ...
            this.setContext = function (ctx) {
                ...
                if (this.style('fill').Definition.isUrl()) {
                    ...
                    if (this.style('fill-opacity').hasValue()) {
                        fillStyle =
                        fillStyle.Color.addOpacity(this
                                                       .style('fill-opacity')
                                                       .value);
                    }
                ...
                if (this.style('stroke').Definition.isUrl()) {
                    ...
                    if (this.style('stroke-opacity').hasValue()) {
                        strokeStyle =
                        strokeStyle.Color.addOpacity(this
        ...
        svg.Element.path = function (node) {
            ...
            this.PathParser = new (function (d) {
                ...
                this.getReflectedControlPoint = function () {
                    if (this.previousCommand.toLowerCase() != 'c' && this.previousCommand
                                                                         .toLowerCase() != 's') {
                        return this.current;
                    }
                        ...
                        case 'A':
                            while (!pp.isCommandOrEnd()) {
                                ...
                                var currp = new svg.Point(
                                    Math.cos(xAxisRotation) * (curr.x - cp.x) / 2.0 + Math
                                                                                          .sin(xAxisRotation)
                                                                                      * (curr.y - cp
                                        .y) / 2.0,
                                    -Math.sin(xAxisRotation) * (curr.x - cp.x) / 2.0 + Math
                                                                                           .cos(xAxisRotation)
                                                                                       * (curr.y
                                                                                          - cp.y)
                                                                                       / 2.0
                                ...
                                var centp = new svg.Point(
                                    (curr.x + cp.x) / 2.0 + Math.cos(xAxisRotation) * cpp.x - Math
                                                                                                  .sin(xAxisRotation)
                                                                                              * cpp
                                        .y,
                                    (curr.y + cp.y) / 2.0 + Math.sin(xAxisRotation) * cpp.x + Math
                                                                                                  .cos(xAxisRotation)
                                                                                              * cpp
                                        .y
                                );
                                ...
                                var a = function (u, v) {
                                    return (u[0] * v[1] < u[1] * v[0] ? -1 : 1) * Math.acos(r(u,
                                                                                              v));
                                }
                                // initial angle
                                var a1 = a([1, 0],
        ...
        svg.Element.stop = function (node) {
            ...
            if (this.style('stop-opacity').hasValue()) {
                stopColor =
                stopColor.Color.addOpacity(this
                                               .style('stop-opacity')
                                               .value);
            }
        ...
        svg.Element.AnimateBase = function (node) {
            ...
            this.update = function (delta) {
                ...
                if (this.duration > this.maxDuration) {
                    ...
                    else if (this.attribute('fill').valueOrDefault('remove') == 'remove' && !this
                            .removed) {
                        this.removed = true;
            ...
            this.renderChildren = function (ctx) {
                ...
                if (customFont != null) {
                    ...
                    for (var i = 0; i < text.length; i++) {
                        ...
                        this.x +=
                        fontSize * (glyph.horizAdvX || customFont.horizAdvX) / customFont.fontFace
                            .unitsPerEm;
            ...
            this.measureText = function (ctx) {
                ...
                if (customFont != null) {
                    ...
                    for (var i = 0; i < text.length; i++) {
                        var glyph = this.getGlyph(customFont, text, i);
                        measure +=
                        (glyph.horizAdvX || customFont.horizAdvX) * fontSize / customFont.fontFace
                            .unitsPerEm;
                        if (typeof(dx[i]) != 'undefined' && !isNaN(dx[i])) {
                            measure += dx[i];
                        }
        ...
        svg.Element.style = function (node) {
            ...
            var css = node.childNodes[0].nodeValue + (node.childNodes.length > 1 ? node
        ...
        svg.Element.use = function (node) {
            ...
            this.setContext = function (ctx) {
                ...
                if (this.attribute('x').hasValue()) {
                    ctx.translate(this.attribute('x').Length
                                      .toPixels('x'), 0);
                }
        ...
        svg.loadXmlDoc = function (ctx, dom) {
            ...
            var draw = function () {
                ...
                if (ctx.canvas.parentNode) {
                    svg.ViewPort.SetCurrent(ctx.canvas.parentNode
                                                .clientWidth,
    ...
    extend(CanVGRenderer.prototype, {
        ...
        configure: function (chart) {
            ...
            addEvent(chart, 'tooltipRefresh', function (args) {
                ...
                // Compute the best position for the tooltip based on the divs size and container
                // size.
                position =
