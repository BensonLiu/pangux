...
class EmailServiceImpl implements EmailService {
  ...
  @Setter
  private String emailConfigLocation = "email/email-config.xml";

  @Setter
  private String charset = "UTF-8";
  @Setter
  private String hostName = "smtp.exmail.qq.com";
  @Setter
  private String fromEmail = "system@eadmarket.com";
  @Setter
  private int smtpport = 465;
  @Setter
  private String username = "system@eadmarket.com";
  @Setter
  private String password = "1admarket";
  ...
  public void initConfig() {
    ...
    InputStream
        emailConfigStream =
        Thread.currentThread().getContextClassLoader().getResourceAsStream(emailConfigLocation);
    try {
