...
class KnowledgeCommentManagerImpl implements KnowledgeCommentManager {
  ...
  @Override
  public Long commentKnowledge(String ip, Long knowledgeId, String comment)
    ...
    try {
      ...
      throw new ManagerException(ExceptionCode.SYSTEM_ERROR,
                                 "failed to get knowledge " + knowledgeId, ex);
    }
    ...
    try {
      ...
      throw new ManagerException(ExceptionCode.SYSTEM_ERROR,
                                 "failed to insert " + knowledgeCommentDO, ex);
    }
  }

  @Override
  public List<KnowledgeCommentDO> queryCommentByKnowledgeId(Long knowledgeId)
      throws ManagerException {
    try {
