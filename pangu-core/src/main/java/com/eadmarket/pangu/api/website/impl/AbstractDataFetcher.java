...
abstract class AbstractDataFetcher implements IDataFetcher {
    ...
    protected String getHTMLContent(String url) {
		...
		try {
			 ...
			 * 伪装浏览器要装得像一点
			 */
			urlCon.setRequestProperty("User-Agent", "Mozilla/5.0 (Macintosh; U; Intel Mac OS X 10.9; en-US; rv:1.9.2.2) Gecko/20100316 Firefox/3.6.2");
