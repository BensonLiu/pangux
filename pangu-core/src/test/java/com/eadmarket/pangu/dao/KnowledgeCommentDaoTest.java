...
public class KnowledgeCommentDaoTest extends BaseTest {
    ...
    @Test public void testInsertComment() throws DaoException {
    ...
    @Test public void testQueryCommentByKnowledgeId() throws DaoException {
        List<KnowledgeCommentDO> knowledgeCommentDOs = knowledgeCommentDao.queryCommentByKnowledgeId(14L);
