...
public class AdvertiseDaoTest extends BaseTest {
  ...
  @Test
  public void testQueryPositionForTimer() throws DaoException {
    List<AdvertiseDO>
        positions =
        advertiseDao.queryPositionsForTimer(0L, AdvertiseDO.AdvertiseStatus.ON_SALE);
  ...
  @Test
  public void testGetActiveContractByAdvertiseId_with_notExistedId() throws DaoException {
    Long notExistedAdvertiseId = -1L;

    AdvertiseContractDO
        nullAdvertise =
        advertiseDao.getActiveContractByAdvertiseId(notExistedAdvertiseId);

    assertThat(nullAdvertise, is(nullValue()));
  }

  @Test
  public void testUpdateContractStatusByAdvertiseId_with_unExistedContract() throws DaoException {
    advertiseDao.updateContractStatusByAdvertiseId(0L, AdvertiseContractDO.INVALID_STATUS);
  }

  @Test
  public void testUpdateContractStatusByAdvertiseId_with_existedContract() throws DaoException {
    advertiseDao.updateContractStatusByAdvertiseId(24L, AdvertiseContractDO.INVALID_STATUS);

    Map<String, Object>
        map =
        adJdbcTemplate.queryForMap("select status from advertise_contract where advertise_id = 24");
